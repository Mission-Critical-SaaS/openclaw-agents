...
if [ -z "$INSTANCE_ID" ]; then
  ...
  echo ""
  echo "Examples:"
  echo "  $0 i-0c6a99a3e95cd52d6              # rollback to previous commit"
  echo "  $0 i-0c6a99a3e95cd52d6 v1.0.0       # rollback to specific tag"
  echo "  $0 i-0c6a99a3e95cd52d6 abc1234       # rollback to specific SHA"
  exit 1
fi
